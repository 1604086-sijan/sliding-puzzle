...
final class SlidePuzzleModel {
    private static final int ROWS = 3;
    private static final int COLS = 3;
    
    private final Tile[][] _contents;  // All tiles.
...
class Tile {
    //============================================ instance variables
    private final int _row;     // row of final position
    private final int _col;     // col of final position
